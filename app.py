    ...
    if request.method == 'POST':
        ...
        if t_name and t_class and file:
            try:
                ...
                for row in reader:
                    q_id_counter += 1 # 毎回IDをプラス1する
                    # idを含めてINSERTする
                    cur.execute('''
                        INSERT INTO questions (id, test_id, q_no, category, question, target, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, answer, explanation)
                        VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)
                    ''', (q_id_counter, new_test_id, 
